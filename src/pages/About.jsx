    ...
    <>
      <div className="flex flex-col w-full h-full">
        ...
        <div className="flex flex-row w-full h-full justify-around items-center">
          ...
          <div className="lg:w-[30%] flex flex-col justify-center items-center">
            <div className="flex flex-row justify-center items-center w-full h-full px-8 py-2">
              <span className="w-[10%] text-current text-start text-[#e4e4e4] text-2xl">02</span>
              <h2 className="w-[90%] text-black  font-medium">Superior finish</h2>
            </div>
            <div className="flex flex-row justify-center items-center w-full h-full px-8 py-2 font-light opacity-50">
          ...
          <div className="lg:w-[30%] flex flex-col justify-center items-center">
            <div className="flex flex-row justify-center items-center w-full h-full px-8 py-2">
              <span className="w-[10%] text-current text-start text-[#e4e4e4] text-2xl">03</span>
              <h2 className="w-[90%] text-black  font-medium">Technical expertise</h2>
            </div>
            <div className="flex flex-row justify-center items-center w-full h-full px-8 py-2 font-light opacity-50">
