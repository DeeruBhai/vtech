  ...
  return (
    <div className="flex m-auto p-4 flex-col md:flex-row gap-24 justify-center items-center h-full">
      <div className="flex flex-col gap-6 items-center md:items-start ">
        ...
        <div className="w-full items-center md:items-start flex-col md:flex:row flex">
          <h2 className="font-semibold font-montserrat">Location</h2>
          <span className="text-sm font-palanquin">
            Vaijeyanthi F10-First floor, Visthara apartment, Vilangudi, Madurai
            - 625018{" "}
          </span>
        </div>
        <div className="w-1/2 items-center md:items-start flex-col md:flex:row flex">
          ...
          <span className="text-sm font-palanquin">vm488451@gmail.com </span>
        </div>
