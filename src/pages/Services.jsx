      ...
      <div className="font-Poppins bg-white text-white w-full h-100 p-8">
        <div className="text-center w-full h-full flex flex-col item-center ">
          ...
          <div className="flex flex-row flex-wrap  lg:p-8  md:p-8 gap-8  group w-full">
            <div className="bg-dark/10 text-black  border border-2 border-grey lg:w-[30%] md:w-[30%]  sm:w-[100%] sm:mx-auto duration-500 group-hover:blur-sm hover:!blur-none group-hover:scale-[0.85] hover:!scale-100  p-8 rounded-xl mix-blend-luminosity ">
